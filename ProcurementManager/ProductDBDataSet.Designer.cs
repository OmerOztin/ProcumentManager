...
namespace ProcurementManager {
    ...
    public partial class ProductDBDataSet : global::System.Data.DataSet {
        ...
        public partial class ProductsDataTable : global::System.Data.TypedTableBase<ProductsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ProductsRow AddProductsRow(string productName, string location, int identity, int supplierID) {
        ...
        public partial class ProductsRow : global::System.Data.DataRow {
            ...
            public string location {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("\'Products\' tablosundaki \'location\' sütunun değeri DBNull.", e);
                    }
                }
                set {
            ...
            public int identity {
                get {
                    return ((int)(this[this.tableProducts.identityColumn]));
                }
                set {
                    this[this.tableProducts.identityColumn] = value;
                }
            }
            ...
            public string supplierName {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("\'Suppliers\' tablosundaki \'supplierName\' sütunun değeri DBNull.", e);
                    }
                }
                set {
...
namespace ProcurementManager.ProductDBDataSetTableAdapters {
...
SELECT MigrationId, ContextKey, Model, ProductVersion FROM __MigrationHistory WHERE (ContextKey = @ContextKey) AND (MigrationId = @MigrationId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ProcurementManager.Properties.Settings.Default.ProductDBConnectionString;
        }
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Products] WHERE (([productID] = @Original_productID) AND ([ide" +
                "ntity] = @Original_identity) AND ([supplierID] = @Original_supplierID))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_identity", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "identity", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Products] ([productName], [location], [identity], [supplierID]) VALUES (@productName, @location, @identity, @supplierID);
SELECT productID, productName, location, [identity], supplierID FROM Products WHERE (productID = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@identity", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "identity", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Products] SET [productName] = @productName, [location] = @location, [identity] = @identity, [supplierID] = @supplierID WHERE (([productID] = @Original_productID) AND ([identity] = @Original_identity) AND ([supplierID] = @Original_supplierID));
SELECT productID, productName, location, [identity], supplierID FROM Products WHERE (productID = @productID)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@identity", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "identity", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_identity", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "identity", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT productID, productName, location, [identity], supplierID FROM dbo.Products" +
                "";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_productID, int Original_identity, int Original_supplierID) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_productID));
            this.Adapter.DeleteCommand.Parameters[1].Value = ((int)(Original_identity));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(string productName, string location, int identity, int supplierID) {
            if ((productName == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[2].Value = ((int)(identity));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string productName, string location, int identity, int supplierID, int Original_productID, int Original_identity, int Original_supplierID, int productID) {
            if ((productName == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[2].Value = ((int)(identity));
            ...
            this.Adapter.UpdateCommand.Parameters[5].Value = ((int)(Original_identity));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string productName, string location, int identity, int supplierID, int Original_productID, int Original_identity, int Original_supplierID) {
            return this.Update(productName, location, identity, supplierID, Original_productID, Original_identity, Original_supplierID, Original_productID);
        }
    }
    ...
    public partial class SuppliersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Suppliers] SET [supplierName] = @supplierName WHERE (([supplierID] " +
                "= @Original_supplierID));\r\nSELECT supplierID, supplierName FROM Suppliers WHERE " +
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(ProductDBDataSet.SuppliersDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual ProductDBDataSet.SuppliersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ProductDBDataSet.SuppliersDataTable dataTable = new ProductDBDataSet.SuppliersDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ProductDBDataSet.SuppliersDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string supplierName, int Original_supplierID, int supplierID) {
            if ((supplierName == null)) {
                this.Adapter.UpdateCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string supplierName, int Original_supplierID) {
            return this.Update(supplierName, Original_supplierID, Original_supplierID);
        }
    }
